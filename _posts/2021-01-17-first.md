...
핵심 : rnn 의 은닉충인 단순 h 말고 C 도 이

- C : 기억/망각 정도를 학습한 쉘
- gate : 신호의 양을 조정해주는 기법
  - forget gate : 그 전 신호에서 불필요한 정보 망각 "영어 문장에서 Snoopy is happy. You are happy " 라는 문장이 있다고 하였을 때 "앞에 주어는 3인칭이 is 야" 를 기억하는 것은 불필요합니다. 주어가 바뀌었기 때문입니다. 이처럼 각 신호에서 더 이상 쓸모 없는 부분이 된 것은 잊어줘야 합니다. 
